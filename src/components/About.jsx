    ...
    render() {
        return (
            <div className='aboutPage'>
                ...
                {/* <hr />
                <p>NOTE: Due to issues beyond my control (server-side database connection errors), the project page is NOT working as intended. Please visit <a href="https://github.com/NathanHannon">my GitHub profile</a> to see my projects. I apologize for any inconvenience</p> */}
            </div>
        );
    }
}
